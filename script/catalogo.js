// =========================================================================
// OLYMPUS OVERS — Lógica del Catálogo de Productos y Modal de Compra
// =========================================================================

// CONFIGURACIÓN CENTRAL Y BASE DE DATOS DE PRODUCTOS
// Para agregar, editar o eliminar productos, modifica la siguiente lista:
const PRODUCTS = [
    { 
        id: 1, 
        genero: 'unisex', 
    ...
    { 
        ...
        genero: 'unisex', 
        cat: 'BoxFit', 
        title: 'BoxFit Zeus- LIMITED EDITION', 
        ...
        desc: `
            ...
            <ul class="list-disc pl-4 space-y-1 text-olympus-gris">
                ...
                <li>Cuello reinforced y acabados premium.</li>
    ...
    { 
        ...
        desc: `
            ...
            <ul class="list-disc pl-4 space-y-1 text-olympus-gris">
                ...
                <li>Ligera, fresca y transpirable.</li>
                <li>Ideal para entrenamiento y uso diario.</li>
                <li>Costuras reinforced para una mayor durabilidad.</li>
            </ul>    
        `,
        colores: [ { name: 'Negro', hex: '#000000' } ]
    },
...
// Número de atención para pedidos vía WhatsApp
const whatsappNumber = "529511112233";
...
// RENDERIZADO DEL CATÁLOGO DE PRODUCTOS (GRID)
function renderGrid() {
    ...
    // Filtrar la lista de productos por género y categoría
...
// CONTROLADORES DE EVENTOS PARA FILTROS DE BÚSQUEDA
...
// ESTRUCTURA E INYECCIÓN DEL MODAL DETALLE DE PRODUCTO
const modalHTML = `
    ...
    <div id="bottom-sheet" class="fixed bottom-0 left-1/2 transform -translate-x-1/2 w-full max-w-md bg-olympus-card z-50 rounded-t-3xl border-t border-gray-800 transition-transform duration-300 translate-y-full flex flex-col max-h-[90vh] shadow-[0_-10px_40px_rgba(0,0,0,0.5)]">
        ...
        <div class="overflow-y-auto px-5 pb-8 custom-scrollbar relative z-10 mb-20 md:mb-0">
            ...
            <!-- Enlace dinámico de pedido por WhatsApp -->
...
// Insertar el modal al cargar el script
document.body.insertAdjacentHTML('beforeend', modalHTML);

const modalOverlay = document.getElementById('modal-overlay');
const bottomSheet = document.getElementById('bottom-sheet');
const waBtn = document.getElementById('m-wa-btn');
const carouselEl = document.getElementById('m-img-carousel');


// LÓGICA DE INTERACCIÓN Y NAVEGACIÓN EN EL CARRUSEL
let isDown = false;
let startX;
let scrollLeft;
...
if (carouselEl) {
    ...
    carouselEl.addEventListener('mouseleave', () => { 
        isDown = false; 
        carouselEl.classList.add('snap-x', 'snap-mandatory');
    });
...
// LÓGICA DEL MODAL DE DETALLES Y COMPRA
const updateWaLink = () => {
    if (!waBtn) return;
...
function openModal(id) {
    ...
    // Configuración de carrusel e indicadores
    ...
    // Enlace dinámico hacia la Guía de Tallas según la categoría del producto
...
// INICIALIZACIÓN Y LECTURA DE FILTROS DESDE URL
